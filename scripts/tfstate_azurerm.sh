...
function upload_tfstate {
    ...
    az storage blob upload -f "${TF_DATA_DIR}/${TF_VAR_environment}/tfstates/${TF_VAR_level}/${TF_VAR_workspace}/${TF_VAR_tf_name}" \
    ...
    rm -f "${TF_DATA_DIR}/${TF_VAR_environment}/tfstates/${TF_VAR_level}/${TF_VAR_workspace}/${TF_VAR_tf_name}" || true
...
function download_tfstate {
    ...
    az storage blob download \
        ...
        --name ${TF_VAR_tf_name} \
        --file "${TF_DATA_DIR}/${TF_VAR_environment}/tfstates/${TF_VAR_level}/${TF_VAR_workspace}/${TF_VAR_tf_name}" \
        --container-name ${TF_VAR_workspace} \
        --auth-mode "key" \
...
function destroy_from_remote_state {
    ...
    rm -rf "${TF_DATA_DIR}/${TF_VAR_environment}/tfstates/terraform.tfstate"
    ...
    case ${terraform_version} in
        *"15"* | *"1."*)
            ...
            terraform -chdir=${landingzone_name} \
                ...
                -out="${TF_DATA_DIR}/${TF_VAR_environment}/tfstates/${TF_VAR_level}/${TF_VAR_workspace}/${TF_VAR_tf_plan}"  | tee ${tf_output_file}
            ;;
        *)
            terraform plan ${plan_command} \
                -refresh=true \
                -state="${TF_DATA_DIR}/${TF_VAR_environment}/tfstates/${TF_VAR_level}/${TF_VAR_workspace}/${TF_VAR_tf_name}" \
                -out="${TF_DATA_DIR}/${TF_VAR_environment}/tfstates/${TF_VAR_level}/${TF_VAR_workspace}/${TF_VAR_tf_plan}" $PWD | tee ${tf_output_file}
            ;;
    esac
    ...
    case ${terraform_version} in
        *"15"* | *"1."*)
            ...
            terraform -chdir=${landingzone_name} \
                apply \
                -state="${TF_DATA_DIR}/${TF_VAR_environment}/tfstates/${TF_VAR_level}/${TF_VAR_workspace}/${TF_VAR_tf_name}" \
                "${TF_DATA_DIR}/${TF_VAR_environment}/tfstates/${TF_VAR_level}/${TF_VAR_workspace}/${TF_VAR_tf_plan}" | tee ${tf_output_file}
            ;;
        *)
            terraform apply \
                -state="${TF_DATA_DIR}/${TF_VAR_environment}/tfstates/${TF_VAR_level}/${TF_VAR_workspace}/${TF_VAR_tf_name}" \
...
function graph {
    ...
    echo "running terraform ${tf_action} -plan="${TF_DATA_DIR}/${TF_VAR_environment}/tfstates/${TF_VAR_level}/${TF_VAR_workspace}/${TF_VAR_tf_plan}" ${graph_command}"
    ...
    terraform graph \
        -plan="${TF_DATA_DIR}/${TF_VAR_environment}/tfstates/${TF_VAR_level}/${TF_VAR_workspace}/${TF_VAR_tf_plan}" ${graph_command}
...
function other {
    ...
    echo "running terraform ${tf_action} -state="${TF_DATA_DIR}/${TF_VAR_environment}/tfstates/${TF_VAR_level}/${TF_VAR_workspace}/${TF_VAR_tf_name}"  ${tf_command}"
